...
page({
  ...
  desc: 'Замена экрана Samsung в Хабаровске: A-серия, S и складные. 30–60 минут, гарантия 90 дней. От 2800₽.',
  ...
  prices: [
    ['Galaxy A-серия', 'от 2800₽'],
    ['Galaxy S-серия', 'от 4500₽'],
    ['Z Fold / Z Flip', 'по диагностике'],
  ],
  faq: [
    ['Сколько стоит экран Samsung в Хабаровске?', 'A-серия от 2800₽, S-серия от 4500₽. Точную цену назовём по модели.'],
...
page({
  ...
  desc: 'Замена экрана Xiaomi / Redmi / POCO в Хабаровске. Часто в день обращения, гарантия 90 дней. От 2200₽.',
  intro: 'На ходовые Redmi и POCO модули часто в наличии — поэтому ремонт обычно 30–60 минут. Диагностика бесплатно.',
  prices: [
    ['Redmi / POCO', 'от 2200₽'],
    ['Xiaomi флагманы', 'от 3500₽'],
    ['Стекло (если применимо)', 'от 700₽'],
  ],
  faq: [
    ['Сколько стоит экран Xiaomi?', 'Ориентир от 2200₽. Зависит от модели.'],
