...
const services = [
  {
    ...
    desc: 'Замена экрана iPhone, Samsung, Xiaomi в Хабаровске. Оригинальные и качественные дисплеи, гарантия 90 дней, ремонт за 30–60 минут. От 1000₽.',
    price: 'от 1000₽',
    ...
    prices: [
      ['iPhone 13', 'от 4500₽'],
      ['iPhone 14', 'от 5500₽'],
      ['Samsung A-серия', 'от 2800₽'],
      ['Xiaomi / Redmi', 'от 2200₽'],
    ],
  },
  {
    file: 'battery.html',
    ...
    desc: 'Замена аккумулятора iPhone, Samsung, Xiaomi в Хабаровске. Телефон снова держит день. Гарантия 90 дней. От 800₽.',
    price: 'от 800₽',
    ...
    prices: [
      ['iPhone 12–13', 'от 2500₽'],
      ['iPhone 14–15', 'от 2800₽'],
      ['Samsung A-серия', 'от 1800₽'],
      ['Xiaomi / Redmi', 'от 1500₽'],
    ],
  },
  {
    file: 'water.html',
    ...
    desc: 'Телефон утонул или намок? Срочная чистка и восстановление в Хабаровске. Чем раньше — тем выше шанс. От 500₽.',
    price: 'от 500₽',
    ...
    faq: [
      ...
      ['Сколько стоит?', 'Чистка от 500₽. Замена деталей — отдельно, до начала работ.'],
    ],
    prices: [
      ['Чистка / сушка', 'от 500₽'],
      ['Замена шлейфа', 'от 800₽'],
  ...
  },
  {
    ...
    desc: 'Диагностика и ремонт, если смартфон не включается или сразу гаснет. Хабаровск, выезд мастера. От 500₽.',
    price: 'от 500₽',
  ...
  },
  {
    ...
    desc: 'Ремонт разъёма зарядки, шлейфа и контроллера в Хабаровске. iPhone, Samsung, Xiaomi. От 800₽, гарантия 90 дней.',
    price: 'от 800₽',
    ...
    prices: [
      ['Чистка разъёма', 'от 500₽'],
      ['Замена разъёма / шлейфа', 'от 800₽'],
